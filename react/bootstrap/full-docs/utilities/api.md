> Źródło: [https://getbootstrap.com/docs/5.3/utilities/api](https://getbootstrap.com/docs/5.3/utilities/api)



[View on GitHub](https://github.com/twbs/bootstrap/blob/v5.3.8/site/src/content/docs/utilities/api.mdx "View and edit this file on GitHub")
...
| `rfs` | Optional | `false` | Boolean to enable [fluid rescaling with RFS](/docs/5.3/getting-started/rfs). |
...
As a list, like with [`text-decoration` utilities](/docs/5.3/utilities/text#text-decoration):

```html
values: none underline line-through
```

As a map, like with [`opacity` utilities](/docs/5.3/utilities/opacity):
...
As a Sass variable that sets the list or map, as in our [`position` utilities](/docs/5.3/utilities/position):
...
Add the `responsive` boolean to generate responsive utilities (e.g., `.opacity-md-25`) across [all breakpoints](/docs/5.3/layout/breakpoints).
